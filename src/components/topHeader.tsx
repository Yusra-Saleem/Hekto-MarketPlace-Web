      ...
      <div className="flex w-full md:w-[1177px]  mx-auto justify-center">
        <div className="flex w-full md:w-[1177px] justify-between">
          ...
          <div className="flex items-center gap-2 bg-transparent">
            <select
              id="language"
              className="hidden md:inline-block bg-transparent text-[12px] sm:text-base cursor-pointer text-white border-none outline-none focus:outline-none focus:border-none  "
            >
              <option
                value="en"
                selected
              ...
              <option value="de" className="bg-black">
                German
              </option>
            </select>
            <select
